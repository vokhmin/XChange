...
public class BinanceMarketDataTest {
  private static final Logger LOGGER = LoggerFactory.getLogger(BinanceMarketDataTest.class);

  private final Class<? extends Exchange> exchangeType = BinanceExchange.class;
